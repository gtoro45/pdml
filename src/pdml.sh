...
rm -rf /home/gabrieltoro45/pdml/src/tests/*.log                         # Gabe DESKTOP
...
LOG_PATH=/home/gabrieltoro45/pdml/src/tests                         # Gabe DESKTOP
cd $LOG_PATH
...
cd /home/gabrieltoro45/pdml/src                         # Gabe Desktop
make clean
make
./pdml